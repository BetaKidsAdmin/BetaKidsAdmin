      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="xl:col-span-1">
            <h3 className="text-sm font-semibold text-white tracking-wider uppercase">Our Mission</h3>
            <p className="text-white text-base mt-4 ">
              BetaKIDS is on a mission to create healthier kids and happier families... one immune system at a time.
            </p>
          </div>
              ...
              <div>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base text-red-100 hover:text-red-200">
                        {item.name}
                      </a>
                    </li>
                  ))}
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          ...
          <p className="mt-6 text-base text-white xl:text-center">&copy; 2022 Beta Kids</p>
        </div>
      </div>
    </footer>
  );
