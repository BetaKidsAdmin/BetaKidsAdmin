  ...
  return (
    <div className="max-w-7xl mx-auto py-16 px-4 sm:py-18 sm:px-6 lg:px-8">
      <div className="text-center">
        {label && <h2 className="text-base font-semibold text-red-500 tracking-wide uppercase">{label}</h2>}
        <p className="mt-1 text-4xl font-extrabold text-red-400 sm:text-5xl sm:tracking-tight lg:text-6xl">{heading}</p>
