...
export const CtaBrandPanelWithOverlappingImage = ({ heading, descriptionHtml, button, image }) => {
  return (
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
            ...
            <div className="max-w-md mx-auto px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
              <div className="aspect-w-10 aspect-h-10 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1 bg-white  rounded-3xl shadow-2xl">
                <NextImage
          ...
          <div className="relative bg-red-400 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <div className="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              ...
              {descriptionHtml && (
                <div className="text-lg text-white" dangerouslySetInnerHTML={{ __html: descriptionHtml }} />
              )}
